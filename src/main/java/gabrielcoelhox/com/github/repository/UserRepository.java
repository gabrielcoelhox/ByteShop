...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    @Query(value = "SELECT u.*, COUNT(o.id) as order_count, SUM(o.total_amount) as total_spent " +
            "FROM users u " +
    ...
    @Query(value = "SELECT u.id, u.name, u.email, AVG(o.total_amount) as average_order_value " +
            "FROM users u " +
            "JOIN orders o ON u.id = o.user_id " +
            "WHERE o.status = 'PAID' " +
